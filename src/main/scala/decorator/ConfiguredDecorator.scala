...
case class ConfiguredDecorator[+DC <: DecoratorConfig, +D <: Decorator[DC]](decorator: D, config: DC)
...
object ConfiguredDecorator {
    ...
    given Codec[ConfiguredDecorator[_, _]] = Registry[Decorator[_]].dispatch(_.decorator, _.codec)
